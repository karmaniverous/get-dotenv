 ...
 * @param {string} [options.dotenvToken] - token indicating a dotenv file
 ...
 * @param {string} [options.paths] - delimited list of input directory paths
 ...
 * @param {string} [options.privateToken] - token indicating private variables
 * @param {GetDotenvPostHookCallback} [config.postHook] - executes side effects within getdotenv context
 * @param {string} [options.vars] - delimited list of explicit environment variable key-value pairs
